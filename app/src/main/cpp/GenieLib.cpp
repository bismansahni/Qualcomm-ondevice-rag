...
extern "C" JNIEXPORT jlong JNICALL Java_bisman_thesis_qualcomm_GenieWrapper_loadModel(JNIEnv* env,
                                                                                   jobject /* this */,
...
extern "C" JNIEXPORT void JNICALL Java_bisman_thesis_qualcomm_GenieWrapper_getResponseForPrompt(JNIEnv* env,
                                                                                             jobject /* this */,
...
extern "C" JNIEXPORT void JNICALL Java_bisman_thesis_qualcomm_GenieWrapper_freeModel(JNIEnv* env,
                                                                                  jobject /* this */,
                                                                                  jlong genie_wrapper_handle)
{
    try
